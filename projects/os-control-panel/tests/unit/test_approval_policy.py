...
class ApprovalPolicyTests(unittest.TestCase):
    ...
    def test_every_registered_action_has_one_stable_risk(self) -> None:
        expected = {
            ...
            "inspect_tool_usage": ApprovalRisk.READ_ONLY,
            "inspect_model_usage": ApprovalRisk.READ_ONLY,
            "inspect_eval_results": ApprovalRisk.READ_ONLY,
            "inspect_related_repo_changes": ApprovalRisk.READ_ONLY,
            "search_system_learning": ApprovalRisk.READ_ONLY,
            "read_optimisation_experiment": ApprovalRisk.READ_ONLY,
            "inspect_relevant_code": ApprovalRisk.READ_ONLY,
